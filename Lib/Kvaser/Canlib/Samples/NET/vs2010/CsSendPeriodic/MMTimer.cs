// From pinvoke.net
// Some slight mods:
//    - added necessary using statements for original code
//    - added a namespace around the class.
//    - made timeBeginPeriod public
...
namespace MMTimers
{
   public class MMTimer : System.IDisposable
   {
      ...
      /// repeat If true sets a repetitive event, otherwise sets a one-shot
   ...
   }  // end of MMTimer class 
}  // end of MMTimers namespace
