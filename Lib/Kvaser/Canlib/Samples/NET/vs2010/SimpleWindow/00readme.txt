CsharpSimpleWindowSample program
================================
...
---------------------------
Open the sln file in Visual Studio.NET.

To be able to build the sample program you must make sure that the path to "canlibCLSNET" in Visual Studio is correct. Do so by using:
Project->CSharpSimpleWindowSample Properties->Common Properties->Reference Path
