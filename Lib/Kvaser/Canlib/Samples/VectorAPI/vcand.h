...
**
** Description:
**   Definitions for the Vector's API to VCAND32.DLL
** ---------------------------------------------------------------------------
*/
...
// Alias for new names
#define V_RECEIVE_MESSAGE V_RECEIVE_MSG
#define V_TRANSMIT_MESSAGE V_TRANSMIT_MSG
...
/* duplicates, see below: #define TRANSCEIVER_TYPE_NONE     0
...
// Bus statistics part 1; frame count and bus load
struct _VstatisticsStd {
...
// Bus statistics part 2; frame count
struct _VstatisticsExt {
...
typedef struct _Vevent {
  ...
  union {
    ...
    struct _VstatisticsStd        statisticsStd;
    struct _VstatisticsExt        statisticsExt;
...
#define HWTYPE_CANCARDX     2        // LAPcan, LAPcan II
#define HWTYPE_PCCAN        8        // PCcan Family
#define HWTYPE_PCICAN       9        // PCIcan Family
#define HWTYPE_USBCAN      11        // USBcan Family and relatives

#define HWTYPE_PCICAN_II   40        // PCIcan II family
#define HWTYPE_USBCAN_II   42        // USBcan II, Memorator et al
#define HWTYPE_SIMULATED   44
#define HWTYPE_ACQUISITOR  46
#define HWTYPE_LEAF        48        // Kvaser Leaf Family
...
#define TRANSCEIVER_TYPE_DNOPTO   3
#define TRANSCEIVER_TYPE_W210     4
#define TRANSCEIVER_TYPE_SWC_PROTO       5  // Prototype. 
#define TRANSCEIVER_TYPE_SWC             6
#define TRANSCEIVER_TYPE_EVA             7
#define TRANSCEIVER_TYPE_FIBER           8
#define TRANSCEIVER_TYPE_K251            9 // K-line + 82c251
#define TRANSCEIVER_TYPE_K              10 // K-line, without CAN
#define TRANSCEIVER_TYPE_1054_OPTO      11 // 1054 with optical isolation
#define TRANSCEIVER_TYPE_SWC_OPTO       12 // SWC with optical isolation
#define TRANSCEIVER_TYPE_TT             13 // B10011S truck-and-trailer
#define TRANSCEIVER_TYPE_1050           14 // TJA1050
#define TRANSCEIVER_TYPE_1050_OPTO      15 // TJA1050 with optical isolation
#define TRANSCEIVER_TYPE_1041           16  // 1041
#define TRANSCEIVER_TYPE_1041_OPTO      17  // 1041 with optical isolation
#define TRANSCEIVER_TYPE_RS485          18  // RS485 (i.e. J1708)
#define TRANSCEIVER_TYPE_LIN            19  // LIN
#define TRANSCEIVER_TYPE_KONE           20  // KONE
...
//
#define MAX_TRANSCEIVER_TYPE                   72
...
Vstatus _EXPORT_DECL ncdRequestStatistic (VportHandle portHandle,
                                          Vaccess    accessMask
);
